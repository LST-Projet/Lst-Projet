...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_title) || empty($product_price) || empty($product_image)){
      ...
      $insert = "INSERT INTO `products`(`product_title`, `product_price`,`product_desc`, `product_image`,`product_keywords`) VALUES('$product_title','$product_price','$product_desc ', '$product_image','$product_keywords')";
      ...
      <table class="product-display-table">
         ...
         <tr>
            ...
            <td>
               ...
               <a href="admin_page.php?delete=<?php echo $row['product_id']; ?>" class="btn"> delete </a>
            </td>
         </tr>
      <?php } ?>
      </table>
